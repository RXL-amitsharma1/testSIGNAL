    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:render template="/emergingIssue/productDictionaryTemplateEmerging"
                          model="[column_names: PVDictionaryConfig.ProductConfig.columns, views: PVDictionaryConfig.ProductConfig.views.sort{it.index}, filters: PVDictionaryConfig.ProductConfig.filters.sort{it.index}, productColumnCode: PVDictionaryConfig.ProductColumnCode, isPVCM: isPVCM]"/>
            </div>
