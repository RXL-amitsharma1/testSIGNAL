...
<asset:javascript src="app/pvs/widgets/alert_filter.js"/>
            ...
            <div id="filter-pane" class="collapse filter">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-xs-2 form-group">
                            <label for="eventSelectionFilter" class="">Event Name</label>
                            <input type="text" placeholder="Event Name" id="eventSelectionFilter",
                                    name="eventSelectionFilter"
                                   class="form-control filterInput">
                        </div>
                    </div>
                ...
                <g:hiddenField name="filterUsed" id="filterUsed" />
            </div>
        </g:form>
    </div>
</div>
