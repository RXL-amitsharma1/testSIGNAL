<div class="modal fade" id="refLinkModal">
        ...
        <div class="modal-content">
            ...
            <div class="msgContainer" style="display:none">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="attachment-name" maxlength="4000">
                </div>

                <div class="form-group">
                    <div class="radio radio-primary radio-inline p-r-5">
                        <input  id="file-type-attach" name="file-type" type="radio" checked="checked" value="Others">
                        <label for="file-type-attach">Attach File</label>
                        <span class="required-indicator">*</span>
                    </div>
                    <div class="radio radio-primary radio-inline">
                        <input name="file-type" id="file-type-link" type="radio" value="Reference">
                    ...
                    <div class="file-uploader" data-provides="fileupload">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn ">
                                <button class="browse btn btn-primary btn-file-upload " id="uploadAttachment" type="button" ><i class="glyphicon glyphicon-search"></i>
                                </button>
                            </span>

                        </div>
                        <span class="error-message file-path hide">Please provide information for all the mandatory fields which are marked with an asterisk (*)</span>
                    </div>
                    <span class="help-block hide">This file is not supported</span>
            ...
            <div class="modal-footer">
                <button type="button" id="cancel-file-link" class="btn btn-default" data-dismiss="modal">
                    Cancel
                </button>
                <button type="button" id="add-file-link" class="btn btn-primary" >
                    Add
                </button>
            </div>
        </div>
