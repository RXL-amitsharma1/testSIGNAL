...
class FileNameCleaner {
    ...
    public static String cleanFileName(String badFileName) {
        String[] spilttedBadFileName = []
        if(badFileName.contains("/")){
            spilttedBadFileName = badFileName.split("/")
            badFileName = spilttedBadFileName ? spilttedBadFileName[spilttedBadFileName.length-1] : badFileName
        }
