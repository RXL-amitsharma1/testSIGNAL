...
class ValidatedSignalReportService {
    ...
    void createReport(JRDataSource dataSource, Map params, ArrayList<JasperReportBuilderEntry> jasperReportBuilderEntryList) {
        if (dynamicReportService.isInPrintMode(params)) {
            ...
            jasperReportBuilderEntry.excelSheetName = "Signal Details Report"
    ...
    private JasperReportBuilder buildReport(JRDataSource dataSource, Map params) {
        ...
        setPrintablePageHeader(report, "Signal Details Report", false, params)
    ...
    private void addColumns(JasperReportBuilder report) {
        report. report
                ...
                .addColumn(Columns.column("Strategy", "strategy", type.stringType()))
                .addColumn(Columns.column("Product Name", "productName", type.stringType()))
                .addcolumn(Columns.column("PEC Count", "noOfPec", type.stringType()))
                .addcolumn(Columns.column("Case Count", "noOfCases", type.stringType()))
                .addcolumn(Columns.column("New/Followup", "newFollowUp", type.stringType()))
                .addcolumn(Columns.column("Current Status", "currentStatus", type.stringType()))
                .addcolumn(Columns.column("Due Date", "dueDate", type.stringType()))
                .addColumn(Columns.column("Initial Data Source", "initialData", type.stringType()))
                ...
                .addColumn(Columns.column("Start Date", "startDate", type.stringType()))
                .addColumn(Columns.column("End Date", "endDate", type.stringType()))
    }
