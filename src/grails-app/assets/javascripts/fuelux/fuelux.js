/*!
 * Fuel UX v3.15.4 with Custom Fixes
 * Copyright 2012-2016 ExactTarget
 * Licensed under the BSD-3-Clause license (https://github.com/ExactTarget/fuelux/blob/master/LICENSE)
 */

// We have added custom fix for the issue of Date Shift. Check Ticket PVR-2944
// !IMPORTANT Customized By Sachin
//TODO need to check for fix on "https://github.com/ExactTarget/fuelux/issues/1827" before any upgrade please check TODO in the code
//TODO need to check for fix on "https://github.com/ExactTarget/fuelux/issues/1839" before any upgrade please check TODO in the code
...
( function( factory ) {
	...
	( function( $ ) {
		...
		Datepicker.prototype = {
			...
			// TODO Added handling for closing all datepickers before showing other https://github.com/ExactTarget/fuelux/issues/1839
			hideAllOpenDatepickers: function () {
				$('.datepicker .input-group-btn.open').trigger("hidden.bs.dropdown");
			},
				...
				if ( date ) {
					if ( this.moment ) { //if we have moment, use that to parse the dates
						momentParseWithFormat = function( d ) {
							var md = moment(d, DATE_TEMPLATES);
							return ( true === md.isValid() ) ? moment(md.toDate(), self.momentFormat).toDate() : BAD_DATE;
						};
	...
	( function( $ ) {
		...
		Scheduler.prototype = {
			...
			setUtcTime: function setUtcTime( day, time, offset ) {
				//TODO need to check for fix on  "https://github.com/ExactTarget/fuelux/issues/1827"
				if (moment) {
					return moment(day + "T" + time, "YYYY-MM-DDTHH:mm");
				}
				// Due to Issue with var utcDate = new Date( Date.UTC( dateSplit[ 0 ], ( dateSplit[ 1 ] - 1 ), dateSplit[ 2 ], timeSplit[ 0 ], timeSplit[ 1 ], ( timeSplit[ 2 ] ? timeSplit[ 2 ] : 0 ) ) );
