...
import com.rxlogix.dms.ApplicationSettings
...
class TestController {
    ...
    def index() {
        ...
        Map dmsConfigMap = grailsApplication.config.dms
        String defaultSetting = new JsonBuilder(dmsConfigMap).toPrettyString()
        [applicationSettingsInstance: applicationSettings, defaultSetting: defaultSetting]
    }

    def saveDmsConfiguration(Long id, String dmsSettings) {
        ApplicationSettings applicationSettings = ApplicationSettings.get(id)
        applicationSettings.dmsIntegration = dmsSettings
